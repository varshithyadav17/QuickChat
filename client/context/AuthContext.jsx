...
export const AuthProvider = ({ children }) => {
    ...
    const sendLoginOTP = async (email) => {
        try {
            ...
            const { data } = await axios.post("/api/auth/send-login-otp", {
                email
            })
    ...
    const verifyLoginOTP = async (email, otp) => {
        try {
            ...
            const { data } = await axios.post("/api/auth/verify-login-otp", {
                email,
                otp
            })
    ...
    console.log("SOCKET EVENT RECEIVED:", event, args)
        ...
        newSocket.on("getOnlineUsers", (userIds)=>{
            ...
            setOfflineUsers(prev => {
                ...
                userIds.forEach(userId => {delete updated[userId]})
        ...
        newSocket.on("UserOffline", ({ userId, lastSeen }) => {
            ...
            console.log("OFFLINE RECEIVED", userId)
